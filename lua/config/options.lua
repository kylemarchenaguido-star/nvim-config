...
-- Make :terminal open PowerShell 7 (pwsh.exe) instead of cmd.exe or legacy
-- Windows PowerShell 5.1, so the profile
-- (Documents\PowerShell\Microsoft.PowerShell_profile.ps1, e.g. the
